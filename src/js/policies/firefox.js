...
const policies = {
  ...
  EnableTrackingProtection : {
    ...
    properties : [
      ...
      {
        name : 'HarmfulAddon',
        label : browser.i18n.getMessage('policy_description_EnableTrackingProtection_HarmfulAddon'),
        type : 'enum',
        options : [
          {
            label : browser.i18n.getMessage('enum_value_no_preference'),
      ...
      {
        name : 'BaselineExceptions',
        label : browser.i18n.getMessage('policy_description_EnableTrackingProtection_BaselineExceptions'),
        type : 'enum',
        options : [
          {
            label : browser.i18n.getMessage('enum_value_no_preference'),
      ...
      {
        name : 'ConvenienceExceptions',
        label : browser.i18n.getMessage('policy_description_EnableTrackingProtection_ConvenienceExceptions'),
        type : 'enum',
        options : [
          {
            label : browser.i18n.getMessage('enum_value_no_preference'),
  ...
  MicrosoftEntraSSO : {
    additional_note : browser.i18n.getMessage('requirement_macos'),
    first_available : { mainstream : '132.0.1', esr : '128.5' },
    ui_category : 'security',
    type : 'enum',
    options : [
      {
