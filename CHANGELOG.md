...
### Version 10.1.0 (Work in Progress)
...
- Updated sourcemeta/jsonschema from version 15.8.0 to 16.0.0
...
- Added support for the `DisableRemoteSettingsAndAcceptSecurityConsequences` policy to prevent Firefox from applying
  remote settings, see [#415](https://github.com/cadeyrn/enterprise-policy-generator/issues/415)
...
- Updated eslint-plugin-jsdoc from version 62.9.0 to 63.0.2
- Updated eslint/json from version 1.2.0 to 2.0.0
- Updated html-eslint/eslint-plugin from version 0.60.0 to 0.61.0
- Updated sourcemeta/jsonschema from version 15.6.2 to 15.8.0
...
- It was not possible to set the value of the `OverrideFirstRunPage` policy to an empty string, see
...
[All Changes](https://github.com/cadeyrn/enterprise-policy-generator/compare/v8.0.0...v8.1.0)<br />
[Download Signed WebExtension](https://addons.mozilla.org/en-US/firefox/addon/enterprise-policy-generator/versions/)
...
- Added support for the `AIControls` policy to enable or disable current and future AI features, see
  [#374](https://github.com/cadeyrn/enterprise-policy-generator/issues/374)
...
- Removed support for the `Extensions` policy as there is the `ExtensionSettings` policy that provides more features,
...
- Updated eslint from version 9.39.2 to 10.1.0
- Updated eslint/json from version 0.14.0 to 1.2.0
- Updated eslint-plugin-jsdoc from version 61.4.1 to 62.8.1
